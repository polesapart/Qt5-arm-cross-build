...
RUN mkdir -p /opt/qt5pi/sysroot/usr /opt/qt5pi/sysroot/opt /opt/qt5pi/sysroot/lib
COPY --from=builder /lib/ /opt/qt5pi/sysroot/lib/
COPY --from=builder /usr/include/ /opt/qt5pi/sysroot/usr/include/
COPY --from=builder /usr/lib/ /opt/qt5pi/sysroot/usr/lib/
COPY --from=builder /opt/vc/ /opt/qt5pi/sysroot/opt/vc/
